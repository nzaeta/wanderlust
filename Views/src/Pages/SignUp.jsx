...
function SignUp() {
  return (
    <div className="Main-Container" className="Main-Container" class="text-gray-300 bg-zinc-900 h-screen flex justify-center items-center">
        ...
        <div className="SignIn-Card" class="w-[500px]" >
          <div className="SignIn-Card_Form">
            <div className="SignIn-Card_Form__Top" class="flex justify-around items-center">
              <Link to="/signIn" class="text-zinc-500">Iniciar Sesión</Link>
              <p>Registrarme</p>
            </div>
            ...
            <div class="flex justify-end" >
              ...
              <span class="pb-1">Registrarme</span>
